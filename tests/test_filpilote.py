...
#   python3 -m unittest test_filpilote.TestFilpilote
# or a specific test with command:
#   python3 -m unittest test_filpilote.TestFilpilote.test__on_configure
# You can get tests coverage with command:
#   coverage run --omit=*/lib/python*/*,test_* --concurrency=thread test_filpilote.py; coverage report -m -i
